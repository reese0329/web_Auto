...
# # a = driver.find_element_by_class_name("pass-form-logo")  #登录弹窗展示，不能获取文本信息
# # print(a.text)
# sleep(1)
...
driver.find_element_by_id("TANGRAM__PSP_10__userName").send_keys("13426257806")
driver.find_element_by_id("TANGRAM__PSP_10__password").clear()
driver.find_element_by_id("TANGRAM__PSP_10__password").send_keys("13426257806")
driver.find_element_by_id("TANGRAM__PSP_10__submit").click()
sleep(3)

driver.find_element_by_id("TANGRAM__39__button_send_mobile").click()
keys = input("输入验证码：")
...
# sleep(3)
driver.find_element_by_id("TANGRAM__39__button_submit").click()
print("login!")
sleep(4)
